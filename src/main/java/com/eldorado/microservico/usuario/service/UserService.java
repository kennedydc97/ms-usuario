...
public class UserService {
    ...
    public UserDto createUser(@Validated UserDto userDto) {
        ...
        log.info("User successfully saved {}", userEntity);
    ...
    private void sendMessage(UserDto userDto, String password) {
        var message = MessageDto
                ...
                .subject(SUBJECT)
                .build();
        log.info("Message to queue {}", message.toString());
    }

    private String passwordGenerator() {
        RandomStringUtils.randomAlphabetic(10);
        return Base64.encodeBase64String(RandomStringUtils.randomAlphabetic(10).getBytes());
    }
}
